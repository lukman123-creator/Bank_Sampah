...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="transition-colors duration-300">
    <head>
        ...
        <script>
            // Script untuk handle initial dark mode
    ...
    <body class="font-sans antialiased text-gray-900 dark:text-gray-100 transition-colors duration-300 relative">
        <!-- Background Gradient -->
        <div class="fixed inset-0 z-[-1] bg-gradient-to-br from-green-50 to-white dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
            <!-- Dekorasi Blobs untuk efek Glassmorphism -->
        ...
        <div class="min-h-screen relative z-10">
            ...
            <!-- Page Heading -->
            @isset($header)
                <header class="bg-white/40 dark:bg-gray-800/40 backdrop-blur-md border-b border-white/20 dark:border-gray-700/50 shadow-sm transition-colors duration-300">
