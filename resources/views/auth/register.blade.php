<x-guest-layout>
    <div class="min-h-screen flex w-full bg-[#0a110d]">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-16 xl:p-24 bg-[#0a110d] relative overflow-y-auto">
            ...
            <div class="w-full max-w-md my-auto pt-16 lg:pt-0">
                <h2 class="text-3xl font-bold text-white mb-10">Sign up</h2>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-8">
                    ...
                    <div class="relative">
                        <input id="name" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" 
                            class="peer w-full bg-transparent border-0 border-b-2 border-gray-700 text-white focus:border-green-500 focus:ring-0 px-0 py-2 placeholder-transparent transition-colors" placeholder="Name" />
                        <label for="name" class="absolute left-0 -top-3.5 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-600 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-sm peer-focus:text-green-500">
                            Your Name
                        </label>
                    ...
                    <div class="relative">
                        <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password" 
                            class="peer w-full bg-transparent border-0 border-b-2 border-gray-700 text-white focus:border-green-500 focus:ring-0 px-0 py-2 placeholder-transparent transition-colors" placeholder="Confirm Password" />
                        <label for="password_confirmation" class="absolute left-0 -top-3.5 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-600 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-sm peer-focus:text-green-500">
                            Repeat Password
                        </label>
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        <span class="text-sm text-gray-500">Already a Member? <a href="{{ route('login') }}" class="text-green-500 hover:text-green-400 font-semibold ml-1">Sign in here</a></span>
                    </div>
                </form>
            </div>
            ...
            <div class="hidden sm:flex absolute right-8 top-1/2 transform -translate-y-1/2 flex-col gap-6 items-center">
                ...
                <a href="{{ route('login.google') }}" class="mt-8 bg-white/10 hover:bg-white/20 p-3 rounded-full text-white transition-all backdrop-blur-sm group" title="Sign up with Google">
